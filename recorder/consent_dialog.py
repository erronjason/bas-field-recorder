"""Off-device transcription consent dialog."""
...
class CloudConsentDialog(QDialog):
    """Shown exactly once, the first time the user selects the off-device backend.
    ...
    def __init__(self, parent=None) -> None:
        ...
        body = QLabel(
            "<b>Off-device transcription sends the audio to AssemblyAI's servers</b> "
            ...
            "policy.<br><br>"
            "<b>On-device transcription</b> keeps all audio on this device. It requires "
        ...
        local_btn = buttons.addButton(
            "Use on-device transcription", QDialogButtonBox.ButtonRole.RejectRole
        )
        proceed_btn = buttons.addButton(
            "Understood — proceed", QDialogButtonBox.ButtonRole.AcceptRole
        )
